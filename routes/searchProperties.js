...
module.exports = async (event, context, callback) => {
    ...
    const keyword = event.queryStringParameters && event.queryStringParameters.keyword ? event.queryStringParameters.keyword : '1';
    ...
    const attomResponse = await axios.get(`https://api.gateway.attomdata.com/propertyapi/v1.0.0/property/expandedprofile?address=${(keyword ? keyword : "")}`, header2)
        .then(async res => {
            let listing = [];
